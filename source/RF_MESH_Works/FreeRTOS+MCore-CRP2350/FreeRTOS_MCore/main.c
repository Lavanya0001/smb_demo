// FreeRTOS + Multicore
// Creating and managing task in different cores, and intro to async context fro freeRTOS
// SMP - Symmetric Multi Processing, Having single schedular for 2 cores, affinity is set by the user to run a task in a core.
